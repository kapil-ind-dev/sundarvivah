...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/family_information/edit', 'FamilyController@edit')->name('family_information.edit');
    Route::post('/family_information/update_family_information_status', 'FamilyController@update_family_information_status')->name('family_information.update_family_information_status');
    Route::get('/family_information/destroy/{id}', 'FamilyController@destroy')->name('family_information.destroy');
