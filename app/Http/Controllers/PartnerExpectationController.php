...
class PartnerExpectationController extends Controller
{
     ...
     */
     public function update(Request $request, $id)
     {
         ...
         $partner_expectations->prefer_age_from           = $request->prefer_age_from;
        $partner_expectations->prefer_age_to                = $request->prefer_age_to;
         $partner_expectations->disability_accept          = $request->disability_accept;
         $partner_expectations->prefer_city                = $request->prefer_city;
