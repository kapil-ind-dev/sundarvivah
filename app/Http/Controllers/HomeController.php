...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.index', compact('premium_members', 'new_members','marital_statuses'));
    }
    ...
    public function member_listing(Request $request)
    {
        ...
        $prefer_age_to        = ($request->prefer_age_to != null) ? $request->prefer_age_to : null;
        $prefer_age_from     = ($request->prefer_age_from != null) ? $request->prefer_age_from : null;
        $prefer_city     = ($request->prefer_city != null) ? $request->prefer_city : null;
        $prefer_disability    = ($request->prefer_disability != null) ? $request->prefer_disability : null;
        ...
        return view('frontend.member.member_listing.index', compact('users', 'age_from', 'age_to', 'member_code', 'matital_status', 'religion_id', 'caste_id', 'sub_caste_id', 'mother_tongue', 'profession', 'country_id', 'state_id', 'city_id', 'min_height', 'max_height', 'member_type', 'prefer_age_to', 'prefer_age_from','prefer_city','prefer_disability'));
    }
    ...
    public function view_member_profile($id)
    {
        ...
        return view('frontend.member.public_profile.index', compact('user', 'similar_profiles','lifestyle'));
    }
