...
class PackageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->unlimited_shortlist != null) {
            $package->unlimited_shortlist = 1;
        } else {
            $package->unlimited_shortlist = 0;
        }
        if ($request->fully_unlock_advance_search != null) {
            $package->fully_unlock_advance_search = 1;
        } else {
            $package->fully_unlock_advance_search = 0;
        }
        if ($request->free_whats_app_group_for_direct_chat != null) {
            $package->free_whats_app_group_for_direct_chat = 1;
        } else {
            $package->free_whats_app_group_for_direct_chat = 0;
        }
    ...
    public function update_status(Request $request)
    {
        ...
        if ($package->save()) {
            ...
            flash(translate('Package Status Updated successfully'))->success();
            return 1;
        }
        return 0;
    }
    ...
    public function package_payemnt_methods($id)
    {
        ...
        return view('frontend.package.select_payemnt_method', compact('package', 'manual_payments'));
    }
