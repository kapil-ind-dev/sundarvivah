...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'first_name', 'last_name', 'education', 'marital_status', 'profession', 'height', 'live_city', 'email', 'password', 'code', 'phone','membership','approved', 'verification_code','fcm_token','referred_by','email_verified_at'
    ];
