            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('packages.update', $package->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{translate('Girls Profiles get free assistance')}}</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{translate('View Contact No. with Full Info')}}</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label">{{translate('View Auto Profile Matches')}}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 mt-3">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="unlimited_shortlist" @if ($package->unlimited_shortlist == "1") checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 mt-3">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="fully_unlock_advance_search" @if ($package->fully_unlock_advance_search == "1") checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-3 mt-3">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="free_whats_app_group_for_direct_chat" @if ($package->free_whats_app_group_for_direct_chat == "1") checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
