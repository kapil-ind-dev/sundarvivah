...
<div class="aiz-titlebar mt-2 mb-4">
    <div class="row align-items-center">
        <div class="col-md-6">
            <h1 class="h3">{{translate('Blocked Members')}}</h1>
        </div>
        @can('create_member')
        ...
        <div class="card">
            <div class="card-header row gutters-5">
  				<div class="col text-center text-md-left">
  					<h5 class="mb-md-0 h6">{{ translate('All Blocked members') }}</h5>
  				</div>
  				<div class="col-md-3">
                ...
                <table class="table aiz-table mb-0 table-responsive">
                    <thead>
                        <tr>
                            ...
                            <th data-breakpoints="md">{{translate('Reason')}}</th>
