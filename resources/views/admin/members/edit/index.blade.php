                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <a class="nav-link" id="v-pills-tab-6" data-toggle="pill" href="#physical_attributes" role="tab" aria-controls="v-pills-settings" aria-selected="false">{{translate('Physical Appearance & Life Style')}}</a>
                                @endif
