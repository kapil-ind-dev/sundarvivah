            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        @can('show_members')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('admin.total-members') }}"
                                    class="aiz-side-nav-link  {{ areActiveRoutes(['members.edit', 'members.show']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Total Members') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('members.index', 3) }}"
                                    class="aiz-side-nav-link  {{ areActiveRoutes(['members.edit', 'members.show']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Verified Members') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('members.index', 4) }}"
                                    class="aiz-side-nav-link  {{ areActiveRoutes(['members.edit', 'members.show']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('VIP Members') }}</span>
                                </a>
                            </li>
                        ...
                        @endcan
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('admin.blocked-members') }}"
                                    class="aiz-side-nav-link  {{ areActiveRoutes(['members.edit', 'members.show']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Block/Deactive Member') }}</span>
                                </a>
                            </li>
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-3">
                                ...
                                @can('show_highesteducation')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('highest-education.index') }}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{ translate('Highest Education') }}</span>
                                        </a>
                                    </li>
                                @endcan
                                @can('show_employedin')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('employed-in.index') }}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{ translate('Employed In') }}</span>
                                        </a>
                                    </li>
                                @endcan
                                @can('show_profession')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('profession.index') }}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{ translate('Profession') }}</span>
                                        </a>
                                    </li>
                                @endcan
                                @can('show_countries')
                        ...
                        @endcan
                        @can('show_filter_profile')
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('profile-filter') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Profile Filter') }}</span>
                                </a>
                            </li>
                        @endcan
                        ...
                        @if(get_setting('member_verification'))
                            @can('manage_member_verification_form')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('member_verification_form.index') }}" class="aiz-side-nav-link">
