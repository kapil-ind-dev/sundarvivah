                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('contact-us.store') }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label text-primary-grad"> {{ translate('Contact number') }} <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="contact" placeholder="{{ translate('Enter Your Contact number') }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label text-primary-grad"> {{ translate('Live in city') }} <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="live_in_city" placeholder="{{ translate('Enter your living city') }}" required>
                                    </div>
                                    <div class="mb-3">
