                    ...
                    <ul class="list-inline mb-0 d-flex align-items-center justify-content-end ">
                        ...
                        <li class="list-inline-item mx-4">
                            <a href="{{ route('dashboard') }}" class="d-flex align-items-center text-reset">
                                <img src="{{ static_asset('').'/'.Auth::user()->photo }}"
            ...
            <div class="container">
                <div class="d-lg-flex justify-content-between text-center text-lg-left">
                    ...
                    <ul
                        ...
                        <li
                            class="d-inline-block d-lg-flex pb-1 {{ areActiveRoutes(['dashboard'],'bg-primary-grad') }}">
                            <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-white py-2"
                        ...
                        <li
                            class="d-inline-block d-lg-flex pb-1 {{ areActiveRoutes(['profile_settings'],'bg-primary-grad') }}">
                            <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-white py-2"
                                href="{{ route('profile_settings') }}">
                                <span class="text-primary-grad mb-n1">{{ translate('Edit Profile') }}</span>
                            </a>
                        </li>
