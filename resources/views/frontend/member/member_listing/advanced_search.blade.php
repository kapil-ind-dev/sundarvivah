            ...
            <div class="pb-4">
                <form action="{{ route('member.listing') }}" method="get">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                <label class="form-label" for="name">{{ translate('Prefer Age To') }}</label>
                                <input type="number" name="prefer_age_to" value="{{ $prefer_age_to ?? '' }}" class="form-control" min="0" step="0.01"  >
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                <label class="form-label" for="name">{{ translate('Prefer Age from') }}</label>
                                <input type="number" name="prefer_age_from" value="{{ $prefer_age_from ?? '' }}" class="form-control" min="0" step="0.01"   >
                          </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                <label class="form-label" for="name">{{ translate('Prefer City') }}</label>
                                <input type="number" name="prefer_city" value="{{ $prefer_city ?? '' }}" class="form-control" min="0" step="0.01"  >
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                <label class="form-label" for="name">{{ translate('Prefer Disability') }}</label>
                                <select name="prefer_disability" class="form-control aiz-selectpicker" data-live-search="true" >
                                    <option value="">{{translate('Select One')}}</option>
                                    <option value="1" @if($prefer_disability == 1) selected @endif> {{ 'Yes' }} </option>
                                    <option value="2" @if($prefer_disability == 2) selected @endif> {{ 'No' }} </option>
                                </select>
                          </div>
                        </div>
                    </div>
