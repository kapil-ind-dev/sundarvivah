                    ...
                    <div class="aiz-profile-sidebar">
                        <div class="overflow-hidden position-relative rounded shadow-lg mb-4 bg-white d-none d-xl-block">
                            @php
                                ...
                                $profile_exist = $user->photo;
                            @endphp
                                @if($profile_picture_show && uploaded_asset($user->photo))
                                    <img src="{{ uploaded_asset($user->photo) }}" class="img-fluid w-100 " >
                                @elseif($profile_exist)
                                   <img src="{{ static_asset('').'/'.$profile_exist }}" class="img-fluid w-100 "  >
                                @else
                                   <img src="{{ static_asset($avatar_image) }}" class="img-fluid w-100 " >
                                @endif
                                                ...
                                                <div class="col-sm-6">
                                                    <table class="w-100">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="py-1 fw-600" style="width:55%">{{ translate('Mother tongue') }}</td>
                                                                
                                                                @php 
                                                                    if(!empty($user->physical_attributes->mothere_tongue)){
                                                                        $mothere_tongue = \App\Models\MemberLanguage::where('id', $user->physical_attributes->mothere_tongue)->first();
                                                                    }
                                                                @endphp
                                                                
                                                                <td class="py-1">
                                                                    @if(!empty($mothere_tongue->name))
                                                                        {{ $mothere_tongue->name }}
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                ...
                                                <div class="col-sm-6 border-sm-left ">
                                                    <table class="w-100 ml-sm-4">
                                                        <tbody>
                                                            ...
                                                            <!--</tr>-->
                                                            <tr>
                                                                <td class="py-1 fw-600" style="width:55%">{{ translate('profession') }}</td>
                                                                <td class="py-1">
                                                                    {{ $user->profession ?? '' }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="py-1 fw-600" style="width:55%">{{ translate('Education') }}</td>
                                                                <td class="py-1">
                                                                    {{ $user->education ?? '' }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="py-1 fw-600" style="width:55%">{{ translate('Live in city') }}</td>
                                                                <td class="py-1">
                                                                    {{ $user->live_city ?? '' }}
                                                                </td>
                                                            </tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="py-1 fw-400">
                                                            <span>{{ translate('Heighst Education') }}</span>
                                                        </td>
                                                        @php 
                                                        ...
                                                        <td class="py-1 fw-400">
                                                            <span>{{ translate('Education Details') }}</span>
                                                        </td>
                                                        <td class="py-1">
                                                            {{ $user->member->education_details ?? '' }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            
                                            <table class="table table-borderless border table-responsive mt-3">
                                                <tbody>
                                                    <tr>
                                        ...
                                        <div id="career" class="collapse accordion-body ml-3 ml-md-5 pl-25px"
                                            ...
                                            <table class="w-100">
                                                <tbody>
                                                    <tr>
                                                        <td class="py-1 fw-400">
                                                            <span>{{ translate('Employed In') }}</span>
                                                        </td>
                                                        @php 
                                                            if(!empty($user->member->heighest_education)){
                                                                $employedin = \App\Models\EmployedInModel::where('id', $user->member->employed_in)->first();
                                                            }
                                                        @endphp
                                                        <td class="py-1">
                                                            {{ $employedin->title ?? '' }}
                                                        ...
                                                        @php 
                                                            if(!empty($user->member->heighest_education)){
                                                                $profession = \App\Models\ProfessionModel::where('id', $user->member->profession)->first();
                                                            }
                                                        @endphp
                                ...
                                @if (get_setting('member_physical_attributes_section') == 'on')
                                    ...
                                    <div class="pb-4 accordion-item">
                                        <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                            ...
                                            <div class="ml-4">
                                                <span
                                                    class="fs-18 fw-600 d-block">{{ translate('Physical Attributes & Life Style') }}</span>
                                            </div>
                                        </div>
                                        <div id="physical-attributes" class="collapse accordion-body ml-3 ml-md-5 pl-25px"
                                            data-parent="#profile-accordion">
                                            @if($user->physical_attributes != null)
                                            <div class="border p-3">
                                                <div class="row no-gutters">
                                                    <div class="col-sm-6">
                                                        <table class="w-100">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="py-1">
                                                                        @if($user->physical_attributes->complexion == '1')
                                                                           Very Fair
                                                                        @elseif($user->physical_attributes->complexion == '2')
                                                                           Fair
                                                                        @elseif($user->physical_attributes->complexion == '3')
                                                                           Medium
                                                                        @elseif($user->physical_attributes->complexion == '4')
                                                                           Wheetish
                                                                        @elseif($user->physical_attributes->complexion == '5')
                                                                           Dark
                                                                        @elseif($user->physical_attributes->complexion == '6')
                                                                            Black
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                @if($lifestyle != null)
                                                                <tr>
                                                                    <td class="py-1 fw-600">{{ translate('Diet') }}
                                                                    </td>
                                                                    <td class="py-1">
                                                                        @if($lifestyle->diet == '1')
                                                                           Yes
                                                                        @elseif($lifestyle->diet == '2')
                                                                           No
                                                                        @elseif($lifestyle->diet == '3')
                                                                            Doesn\'t matter
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                                 <tr>
                                                                    <td class="py-1 fw-600">{{ translate('Drink') }}
                                                                    </td>
                                                                    <td class="py-1">
                                                                        @if($lifestyle->drink == '1')
                                                                           Yes
                                                                        @elseif($lifestyle->drink == '2')
                                                                           No
                                                                        @elseif($lifestyle->drink == '3')
                                                                            Doesn\'t matter
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="py-1">
                                                                        ...
                                                                        @if($user->physical_attributes->blood_group == '1')
                                                                           A+
                                                                        @elseif($user->physical_attributes->blood_group == '2')
                                                                           O+
                                                                        @elseif($user->physical_attributes->blood_group == '3')
                                                                           B+
                                                                        @elseif($user->physical_attributes->blood_group == '4')
                                                                           AB+
                                                                        @elseif($user->physical_attributes->blood_group == '5')
                                                                           A- 
                                                                        @elseif($user->physical_attributes->blood_group == '6')
                                                                           O-
                                                                        @elseif($user->physical_attributes->blood_group == '7')
                                                                           B-
                                                                       @elseif($user->physical_attributes->blood_group == '8')
                                                                            AB-
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                @if($lifestyle != null)
                                                                <tr>
                                                                    <td class="py-1 fw-600">{{ translate('Smoke') }}
                                                                    </td>
                                                                    <td class="py-1">
                                                                        @if($lifestyle->smoke == '1')
                                                                           Yes
                                                                        @elseif($lifestyle->smoke == '2')
                                                                           No
                                                                        @elseif($lifestyle->smoke == '3')
                                                                            Doesn\'t matter
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="py-1 fw-600">{{ translate('Living with') }}
                                                                    </td>
                                                                    <td class="py-1">
                                                                        @if($lifestyle->living_with == '1')
                                                                           Family
                                                                        @elseif($lifestyle->living_with == '2')
                                                                           Alone
                                                                        @elseif($lifestyle->living_with == '3')
                                                                           Friend
                                                                        @elseif($lifestyle->living_with == '4')
                                                                           Relationship
                                                                        @elseif($lifestyle->living_with == '5')
                                                                            Relative
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <div class="col-md-6">
                                                        <table class="w-100">
                                                            <tr>
                                                                ...
                                                                <td class="py-1">
                                                                    @if($user->hobbies->hobbies == '1')
                                                                       Bird Watching
                                                                    @elseif($user->hobbies->hobbies == '2')
                                                                       Taking care of pets
                                                                    @elseif($user->hobbies->hobbies == '3')
                                                                       Playing musical instruments
                                                                    @elseif($user->hobbies->hobbies == '4')
                                                                       Singing
                                                                    @elseif($user->hobbies->hobbies == '5')
                                                                       Dancing
                                                                   @elseif($user->hobbies->hobbies == '6')
                                                                       Acting
                                                                   @elseif($user->hobbies->hobbies == '7')
                                                                       Ham radio
                                                                   @elseif($user->hobbies->hobbies == '8')
                                                                       Astrology/ Palmistry/ Numerology
                                                                   @elseif($user->hobbies->hobbies == '9')
                                                                       Graphology
                                                                   @elseif($user->hobbies->hobbies == '10')
                                                                       Solving Crosswords, Puzzels
                                                                    @elseif($user->hobbies->hobbies == '11')
                                                                       Fishing
                                                                    @elseif($user->hobbies->hobbies == '12')
                                                                      Collecting Stamps
                                                                    @elseif($user->hobbies->hobbies == '13')
                                                                       Collecting Coins
                                                                    @elseif($user->hobbies->hobbies == '14')
                                                                       Collecting antiques
                                                                    @elseif($user->hobbies->hobbies == '15')
                                                                       Art/Handicraft
                                                                    @elseif($user->hobbies->hobbies == '16')
                                                                       Painting
                                                                    @elseif($user->hobbies->hobbies == '17')
                                                                       Cooking
                                                                    @elseif($user->hobbies->hobbies == '18')
                                                                       Photography
                                                                    @elseif($user->hobbies->hobbies == '19')
                                                                       Film-making
                                                                    @elseif($user->hobbies->hobbies == '20')
                                                                       Model building
                                                                    @elseif($user->hobbies->hobbies == '21')
                                                                       Gardening/Landscaping
                                                                    @elseif($user->hobbies->hobbies == '22')
                                                                        Art/Handicraft
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="py-1">
                                                                    @if($user->hobbies->music == '1')
                                                                       Pop
                                                                    @elseif($user->hobbies->music == '2')
                                                                       Disco
                                                                    @elseif($user->hobbies->music == '3')
                                                                       House Music
                                                                    @elseif($user->hobbies->music == '4')
                                                                       Techno
                                                                    @elseif($user->hobbies->music == '5')
                                                                       Hip-Hop
                                                                   @elseif($user->hobbies->music == '6')
                                                                       Rap
                                                                   @elseif($user->hobbies->music == '7')
                                                                       Jazz
                                                                   @elseif($user->hobbies->music == '8')
                                                                       Blue
                                                                   @elseif($user->hobbies->music == '9')
                                                                       Raggae
                                                                   @elseif($user->hobbies->music == '10')
                                                                       Heavy Metal
                                                                    @elseif($user->hobbies->music == '11')
                                                                       Acid Rock
                                                                    @elseif($user->hobbies->music == '12')
                                                                      Classical-Hindustani
                                                                    @elseif($user->hobbies->music == '13')
                                                                      Classical-Carnatic
                                                                    @elseif($user->hobbies->music == '14')
                                                                       Classical-Western
                                                                    @elseif($user->hobbies->music == '15')
                                                                       Instrumental-Indian
                                                                    @elseif($user->hobbies->music == '16')
                                                                       Instrumental-Western
                                                                    @elseif($user->hobbies->music == '17')
                                                                       Old film songs
                                                                    @elseif($user->hobbies->music == '18')
                                                                       Ghazals
                                                                    @elseif($user->hobbies->music == '19')
                                                                       Indipop
                                                                    @elseif($user->hobbies->music == '20')
                                                                       Qawalis
                                                                    @elseif($user->hobbies->music == '21')
                                                                       Bhajans/Devotional
                                                                    @elseif($user->hobbies->music == '22')
                                                                        Sufi music
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="py-1">
                                                                    @if($user->hobbies->sports == '1')
                                                                       Jogging / Walking
                                                                    @elseif($user->hobbies->sports == '2')
                                                                       Cycling
                                                                    @elseif($user->hobbies->sports == '3')
                                                                       Swimming / Water Sports
                                                                    @elseif($user->hobbies->sports == '4')
                                                                       Cricket
                                                                    @elseif($user->hobbies->sports == '5')
                                                                       Yoga / Meditation
                                                                   @elseif($user->hobbies->sports == '6')
                                                                       Martial Arts
                                                                   @elseif($user->hobbies->sports == '7')
                                                                       Hockey
                                                                   @elseif($user->hobbies->sports == '8')
                                                                       Football
                                                                   @elseif($user->hobbies->sports == '9')
                                                                       Volleyball
                                                                   @elseif($user->hobbies->sports == '10')
                                                                       Bowling
                                                                    @elseif($user->hobbies->sports == '11')
                                                                       Chess
                                                                    @elseif($user->hobbies->sports == '12')
                                                                      Carrom
                                                                    @elseif($user->hobbies->sports == '13')
                                                                      Scrabble
                                                                    @elseif($user->hobbies->sports == '14')
                                                                       Card Games
                                                                    @elseif($user->hobbies->sports == '15')
                                                                       Billiards/Snooker/Pool
                                                                    @elseif($user->hobbies->sports == '16')
                                                                       Aerobics
                                                                    @elseif($user->hobbies->sports == '17')
                                                                       Weight Training
                                                                    @elseif($user->hobbies->sports == '18')
                                                                       Golf
                                                                    @elseif($user->hobbies->sports == '19')
                                                                       Basketball
                                                                    @elseif($user->hobbies->sports == '20')
                                                                       Tennis
                                                                    @elseif($user->hobbies->sports == '21')
                                                                       Squash
                                                                    @elseif($user->hobbies->sports == '22')
                                                                       Table- Tennis
                                                                    @elseif($user->hobbies->sports == '23')
                                                                       Badminton
                                                                    @elseif($user->hobbies->sports == '24')
                                                                       Baseball
                                                                    @elseif($user->hobbies->sports == '25')
                                                                       Rugby
                                                                    @elseif($user->hobbies->sports == '26')
                                                                        Adventure Sports
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td class="py-1">
                                                                    @if($user->hobbies->cuisines == '1')
                                                                       South Indian
                                                                    @elseif($user->hobbies->cuisines == '2')
                                                                       Punjabi
                                                                    @elseif($user->hobbies->cuisines == '3')
                                                                       Gujrati
                                                                    @elseif($user->hobbies->cuisines == '4')
                                                                       Rajasthani
                                                                    @elseif($user->hobbies->cuisines == '5')
                                                                       Bengali
                                                                   @elseif($user->hobbies->cuisines == '6')
                                                                       Konkan
                                                                   @elseif($user->hobbies->cuisines == '7')
                                                                       Chinse
                                                                   @elseif($user->hobbies->cuisines == '8')
                                                                       Continental
                                                                   @elseif($user->hobbies->cuisines == '9')
                                                                       Moghlai
                                                                   @elseif($user->hobbies->cuisines == '10')
                                                                       Italian
                                                                    @elseif($user->hobbies->cuisines == '11')
                                                                       Arabic
                                                                    @elseif($user->hobbies->cuisines == '12')
                                                                      Thai
                                                                    @elseif($user->hobbies->cuisines == '13')
                                                                      Sushi
                                                                    @elseif($user->hobbies->cuisines == '14')
                                                                       Mexican
                                                                    @elseif($user->hobbies->cuisines == '15')
                                                                       Lebanese
                                                                    @elseif($user->hobbies->cuisines == '16')
                                                                       Latin American
                                                                    @elseif($user->hobbies->cuisines == '17')
                                                                       Spanish
                                                                     @elseif($user->hobbies->cuisines == '18')
                                                                        Fast Food
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table class="w-100 ml-sm-4">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class="py-1">
                                                                    @if($user->hobbies->interests == '1')
                                                                       Writing
                                                                    @elseif($user->hobbies->interests == '2')
                                                                       Reading/Book clubs
                                                                    @elseif($user->hobbies->interests == '3')
                                                                       Learning new languages
                                                                    @elseif($user->hobbies->interests == '4')
                                                                       Listening to music
                                                                    @elseif($user->hobbies->interests == '5')
                                                                       Movies
                                                                   @elseif($user->hobbies->interests == '6')
                                                                       Theatre
                                                                   @elseif($user->hobbies->interests == '7')
                                                                       Watching television
                                                                   @elseif($user->hobbies->interests == '8')
                                                                       Travel/Sightseeing
                                                                   @elseif($user->hobbies->interests == '9')
                                                                       Sports-Outdoor
                                                                   @elseif($user->hobbies->interests == '10')
                                                                       Sports-Indoor
                                                                    @elseif($user->hobbies->interests == '11')
                                                                       Trekking/Adventure sports
                                                                    @elseif($user->hobbies->interests == '12')
                                                                      Video/Computer games
                                                                    @elseif($user->hobbies->interests == '13')
                                                                       Health & Fitness
                                                                    @elseif($user->hobbies->interests == '14')
                                                                       Yoga/Meditation
                                                                    @elseif($user->hobbies->interests == '15')
                                                                       Alternative healing
                                                                    @elseif($user->hobbies->interests == '16')
                                                                       Volunteering/Social Service
                                                                    @elseif($user->hobbies->interests == '17')
                                                                       Politics
                                                                    @elseif($user->hobbies->interests == '18')
                                                                       Net Surfing
                                                                    @elseif($user->hobbies->interests == '19')
                                                                        Blogging
                                                                    @endif
                                                                </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td class="py-1">
                                                                        @if($user->hobbies->books == '1')
                                                                           Romance
                                                                        @elseif($user->hobbies->books == '2')
                                                                           Thriller/Suspence
                                                                        @elseif($user->hobbies->books == '3')
                                                                           Humor
                                                                        @elseif($user->hobbies->books == '4')
                                                                           Science Fiction
                                                                        @elseif($user->hobbies->books == '5')
                                                                           Fantasy
                                                                       @elseif($user->hobbies->books == '6')
                                                                           Business/Occupational
                                                                       @elseif($user->hobbies->books == '7')
                                                                           Philosophy/Spritual
                                                                       @elseif($user->hobbies->books == '8')
                                                                           Self-help
                                                                       @elseif($user->hobbies->books == '9')
                                                                           Short stories
                                                                       @elseif($user->hobbies->books == '10')
                                                                           Comics
                                                                        @elseif($user->hobbies->books == '11')
                                                                           Magazines & Newspapers
                                                                        @elseif($user->hobbies->books == '12')
                                                                          Classic literature
                                                                        @elseif($user->hobbies->books == '13')
                                                                           Biographies
                                                                        @elseif($user->hobbies->books == '14')
                                                                           History
                                                                        @elseif($user->hobbies->books == '15')
                                                                            Poetry
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="py-1">
                                                                        @if($user->hobbies->dress_styles == '1')
                                                                           Classical Indian - Typical Indian formal Wear
                                                                        @elseif($user->hobbies->dress_styles == '2')
                                                                           Trendy - in Line With the latest Fashion
                                                                        @elseif($user->hobbies->dress_styles == '3')
                                                                           Classic Western - Typical Western Formal Wear
                                                                        @elseif($user->hobbies->dress_styles == '4')
                                                                           Designer - Only Leading Brands Will do
                                                                       @elseif($user->hobbies->dress_styles == '5')
                                                                            Casual - Usually in Jeans & T-shirts
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                            ...
                                            <table class="table table-borderless border table-responsive mt-3">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th>{{ translate('Profession Status') }}</th>
                                                        <th>{{ translate('Details') }}</th>
                                                    </tr>
                                                    @php $families = \App\Models\Family::where('user_id', $user->id)->get(); @endphp
