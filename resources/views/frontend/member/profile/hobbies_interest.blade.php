<div class="card">
    ...
    <div class="card-body">
      <form action="{{ route('hobbies.update', $member->id) }}" method="POST">
          ...
          <div class="form-group row">
              <div class="col-md-6">
                  <label for="movies">{{translate('Favourite Movie')}}</label>
                  <input type="text" name="movies" value="{{ $member->hobbies->movies ?? "" }}" class="form-control" placeholder="{{translate('Favourite Movie')}}">
              </div>
              <div class="col-md-6">
                  <label for="tv_shows">{{translate('Favourite T.V. Shows')}}</label>
                  <input type="text" name="tv_shows" value="{{ $member->hobbies->tv_shows ?? "" }}" placeholder="{{ translate('Favourite T.V. Shows') }}" class="form-control">
              </div>
          </div>
          <div class="form-group row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                  <label for="fitness_activities">{{translate('Favourite Vacation Places')}}</label>
                  <input type="text" name="fitness_activities" value="{{ $member->hobbies->fitness_activities ?? "" }}" placeholder="{{ translate('Favourite Vacation Places') }}" class="form-control">
              </div>
          </div>
          <div class="form-group row">
              <div class="col-md-6">
