<form action="{{ route('education.store') }}" method="POST">
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            <label class="col-md-3 col-form-label">{{translate('Degree/Deploma')}} <br>  Course </label>
            <div class="col-md-9">
        ...
        <div class="form-group row">
            <label class="col-md-3 col-form-label">{{translate('Passing year')}}</label>
            <div class="col-md-9">
                <input type="number" name="education_start" class="form-control" placeholder="{{translate('Passing year')}}" required>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-3 col-form-label">{{translate('Percentage (%)')}}</label>
            <div class="col-md-9">
                <input type="number" name="education_end"  placeholder="{{ translate('Percentage (%)') }}" class="form-control" >
            </div>
        </div>
    </div>
