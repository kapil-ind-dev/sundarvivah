        ...
        <form action="{{ route('partner_expectations.update', $member->id) }}" method="POST">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input type="text" name="general" value="{{ $member->partner_expectations->general ?? "" }}" class="form-control" placeholder="{{translate('General')}}"  >
                </div>
                <div class="col-md-6">
                    <label for="residence_country_id">{{translate('Residence Country')}}</label>
                    <select class="form-control aiz-selectpicker" name="residence_country_id" data-selected="{{ $member->partner_expectations->residence_country_id ?? "" }}" data-live-search="true"  >
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="partner_weight" value="{{ $member->partner_expectations->weight ?? "" }}" step="any" class="form-control" placeholder="{{translate('Weight')}}"  >
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    <label for="partner_height">{{translate('Prefer Age From')}}</label>
                    <input type="number" name="prefer_age_from" value="{{ $member->partner_expectations->prefer_age_from ?? "" }}" step="any"  placeholder="{{ translate('Prefer Age From') }}" class="form-control"  >
                    @error('prefer_age_from')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="col-md-6">
                    <label for="partner_weight">{{translate('Prefer Age To') }})</label>
                    <input type="number" name="prefer_age_to" value="{{ $member->partner_expectations->prefer_age_to ?? "" }}" step="any" class="form-control" placeholder="{{translate('Prefer Age To')}}"  >
                    @error('prefer_age_to')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <select class="form-control aiz-selectpicker" name="partner_marital_status" data-selected="{{ $member->partner_expectations->marital_status_id ?? "" }}" data-live-search="true"  >
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <select class="form-control aiz-selectpicker" name="partner_religion_id" id="partner_religion_id" data-selected="{{ $partner_religion_id }}" data-live-search="true"  >
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-control aiz-selectpicker" name="language_id" data-selected="{{ $member->partner_expectations->language_id ?? "" }}" data-live-search="true"  >
                        <option value="">{{translate('Select One')}}</option>
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <select class="form-control aiz-selectpicker" name="partner_country_id" id="partner_country_id" data-selected="{{ $partner_country_id }}" data-live-search="true"  >
                        <option value="">{{translate('Select One')}}</option>
                        @foreach ($countries as $country)
                            <option value="{{$country->id}}">{{$country->name}}</option>
                        @endforeach
                ...
                <div class="col-md-6">
                    <label for="pertner_complexion">{{translate('Prefer City')}}</label>
                    <input type="text" name="prefer_city" value="{{ $member->partner_expectations->prefer_city ?? "" }}" class="form-control" placeholder="{{translate('Prefer City')}}"  >
                    @error('prefer_city')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="pertner_complexion" value="{{ $member->partner_expectations->complexion ?? "" }}" class="form-control" placeholder="{{translate('Complexion')}}"  >
                ...
                <div class="col-md-6">
                    @php
                        if($member->partner_expectations){
                            $disability = $member->partner_expectations->disability_accept ?? "";
                        }else{
                            $disability = '';
                        }
                    @endphp
                    <label for="partner_marital_status">{{translate('Disability Accept')}}</label>
                    <select class="form-control aiz-selectpicker" name="disability_accept" data-selected="{{ $member->partner_expectations->disability_accept ?? "" }}" data-live-search="true"  >
                        <option value="">{{ translate('Choose One') }}</option>
