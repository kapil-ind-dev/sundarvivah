      ...
      <form action="{{ route('physical-attribute.update', $member->id) }}" method="POST">
          ...
          <div class="form-group row">
              <div class="col-md-6">
                  ...
                  <input type="number" name="height" value="{{ $member->physical_attributes->height ?? "" }}" step="any" class="form-control" placeholder="{{translate('Height')}}"  >
                  @error('height')
              ...
              <div class="col-md-6">
                  ...
                  <input type="number" name="weight" value="{{ $member->physical_attributes->weight ?? "" }}" step="any" placeholder="{{ translate('Weight') }}" class="form-control"  >
                  @error('weight')
                      <small class="form-text text-danger">{{ $message }}</small>
                  @enderror
              </div>
          ...
          <!--        <input type="text" name="eye_color" value="{{ $member->physical_attributes->eye_color ?? "" }}" class="form-control" placeholder="{{translate('Eye Color')}}"  >-->
          <!--        @error('eye_color')-->
          <!--            <small class="form-text text-danger">{{ $message }}</small>-->
          <!--        @enderror-->
          <!--    </div>-->
          ...
          <!--        <input type="text" name="hair_color" value="{{ $member->physical_attributes->hair_color ?? "" }}" placeholder="{{ translate('Hair Color') }}" class="form-control"  >-->
          <!--        @error('hair_color')-->
          <!--            <small class="form-text text-danger">{{ $message }}</small>-->
          <!--        @enderror-->
          <!--    </div>-->
          ...
          <div class="form-group row">
              <div class="col-md-6">
                  ...
                  <input type="text" name="body_type" value="{{ $member->physical_attributes->body_type ?? "" }}" class="form-control" placeholder="{{translate('Body Type')}}"  >
                  @error('body_type')
                      <small class="form-text text-danger">{{ $message }}</small>
                  @enderror
              </div>
              <div class="col-md-6">
                  ...
                  <input type="text" name="body_art" value="{{ $member->physical_attributes->body_art ?? "" }}" placeholder="{{ translate('Body Art') }}" class="form-control"  >
                  @error('body_art')
                      <small class="form-text text-danger">{{ $message }}</small>
                  @enderror
              </div>
          ...
          <div class="form-group row">
            ...
            <div class="form-group row" id="disability_details">
                <div class="col-md-12">
                    <label for="disability_details">{{translate('Disability Details')}}
                        <span class="text-danger">*</span>
                    </label>
                    <input type="text" name="disability_details" value="{{ $member->physical_attributes->disability_details ?? "" }}" placeholder="{{ translate('Disability Details') }}" class="form-control">
