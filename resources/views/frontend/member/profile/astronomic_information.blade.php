    ...
    <div class="card-body">
      <form action="{{ route('astrologies.update', $member->id) }}" method="POST">
          ...
          <div class="form-group row">
              ...
              <div class="col-md-6">
                  <label for="city_of_birth">{{translate('Place/City Of Birth')}}</label>
          ...
          <div class="form-group row">
              <div class="col-md-6">
                  <label for="zodiac">{{translate('Zodiac/Rashi')}}</label>
                  <input type="text" name="zodiac" value="{{ $member->astrologies->zodiac ?? "" }}" class="form-control" placeholder="{{translate('Zodiac/Rashi')}}" >
                  @error('zodiac')
                      <small class="form-text text-danger">{{ $message }}</small>
                  @enderror
              </div>
              <div class="col-md-6">
                  ...
                  <input type="text" name="nakshatra" value="{{ $member->astrologies->nakshatra ?? "" }}" placeholder="{{ translate('Nakshatra') }}" class="form-control" >
                  @error('moon_sign')
                      <small class="form-text text-danger">{{ $message }}</small>
                  @enderror
              </div>
          ...
          <div class="form-group row">
              <div class="col-md-6">
                  ...
                  <input type="text" name="sun_sign" value="{{ $member->astrologies->sun_sign ?? "" }}" class="form-control" placeholder="{{translate('Sun Sign')}}">
                  @error('sun_sign')
                      <small class="form-text text-danger">{{ $message }}</small>
                  @enderror
              </div>
              <div class="col-md-6">
                  ...
                  <input type="text" name="moon_sign" value="{{ $member->astrologies->moon_sign ?? "" }}" placeholder="{{ translate('Moon Sign') }}" class="form-control" >
                  @error('moon_sign')
                      <small class="form-text text-danger">{{ $message }}</small>
                  @enderror
              </div>
